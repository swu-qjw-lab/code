...
if __name__ == "__main__":
    # Argument parsing
    parser = argparse.ArgumentParser(description='MIAM Test Script')
    # Paths
    ...
    parser.add_argument('--benchmark', type=str, default='pfpascal', choices=['pfpascal', 'spair', 'pfwillow'])
    ...
    model = MIAM(
        ...
        hyperpixel_ids=parse_list(args_model.hyperpixel), freeze=True,patch_size =args.patch_size)
    ...
    # num_params = summary(model.to("cuda"), input_size=input_size_img)
