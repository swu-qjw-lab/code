...
def var_all_case_LA(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
    ...
    with open('/home/byl/My_init/BCP-main/data_split/LA/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = ["/home/byl/My_init/BCP-main/Datasets/LA/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
    ...
    for x in range(0, sx):
        ...
        for y in range(0, sy):
            ...
            for z in range(0, sz):
                ...
                with torch.no_grad():
                    y1, _ = model(test_patch,eval=True)
...
def var_all_case_LA_plus(model_l, model_r, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
    ...
    with open('/home/byl/BCP-main/BCP-main/data_split/LA/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = ["/home/byl/BCP-main/BCP-main/Datasets/LA/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
    loader = tqdm(image_list)
    total_dice = 0.0
    for image_path in loader:
        h5f = h5py.File(image_path, 'r')
